...
public class UFramework_Network_SocketPackLinearWrap
{
	public static void Register(LuaState L)
	{
		L.BeginClass(typeof(UFramework.Network.SocketPackLinear), typeof(UFramework.Network.SocketPack));
		...
		L.RegFunction("New", new LuaCSFunction(_CreateUFramework_Network_SocketPackLinear));
		L.RegFunction("__tostring", new LuaCSFunction(ToLua.op_ToString));
		L.EndClass();
	}

	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	static int _CreateUFramework_Network_SocketPackLinear(IntPtr L)
	{
		try
		{
			...
			if (count == 0)
			{
				UFramework.Network.SocketPackLinear obj = new UFramework.Network.SocketPackLinear();
			...
			else if (count == 1)
			{
				...
				UFramework.Network.SocketPackLinear obj = new UFramework.Network.SocketPackLinear(arg0);
				ToLua.PushObject(L, obj);
				return 1;
			}
			else
			{
				return LuaDLL.luaL_throw(L, "invalid arguments to ctor method: UFramework.Network.SocketPackLinear.New");
			}
		}
		catch (Exception e)
		{
	...
	static int Pack(IntPtr L)
	{
		try
		{
			...
			UFramework.Network.SocketPackLinear obj = (UFramework.Network.SocketPackLinear)ToLua.CheckObject<UFramework.Network.SocketPackLinear>(L, 1);
			obj.Pack();
			return 0;
		}
		catch (Exception e)
	...
	static int WriteBytes(IntPtr L)
	{
		try
		{
			...
			{
				return LuaDLL.luaL_throw(L, "invalid arguments to method: UFramework.Network.SocketPackLinear.WriteBytes");
			}
		}
		catch (Exception e)
		{
