...
public class DelegateFactory
{
	...
	{
		return TypeChecker.CheckDelegateType<FairyGUI.EventCallback1>(L, pos);
	}
	...
	{
		return TypeChecker.CheckDelegateType<FairyGUI.EventCallback0>(L, pos);
	}
	...
	{
		return TypeChecker.CheckDelegateType<FairyGUI.ListItemRenderer>(L, pos);
	}
	...
	{
		return TypeChecker.CheckDelegateType<FairyGUI.ListItemProvider>(L, pos);
	}
	...
	{
		return TypeChecker.CheckDelegateType<FairyGUI.PlayCompleteCallback>(L, pos);
	}
	...
	{
		return TypeChecker.CheckDelegateType<FairyGUI.TransitionHook>(L, pos);
	}
	...
	{
		return TypeChecker.CheckDelegateType<System.Action<FairyGUI.PackageItem>>(L, pos);
	}
	...
	class FairyGUI_UIPackage_LoadResource_Event : LuaDelegate
	{
		...
		public object Call(string param0, string param1, System.Type param2, out FairyGUI.DestroyMethod param3)
		{
			...
			param3 = (FairyGUI.DestroyMethod)func.CheckObject(TypeTraits<FairyGUI.DestroyMethod>.type);
			func.EndPCall();
			return ret;
		}
	...
	{
		return TypeChecker.CheckDelegateType<FairyGUI.UIPackage.LoadResource>(L, pos);
	}
	...
	{
		return TypeChecker.CheckDelegateType<FairyGUI.UIPackage.LoadResourceAsync>(L, pos);
	}
	...
	{
		return TypeChecker.CheckDelegateType<FairyGUI.UIPackage.CreateObjectCallback>(L, pos);
	}
	...
	{
		return TypeChecker.CheckDelegateType<FairyGUI.GObjectPool.InitCallbackDelegate>(L, pos);
	}
	...
	{
		return TypeChecker.CheckDelegateType<FairyGUI.GTweenCallback>(L, pos);
	}
	...
	{
		return TypeChecker.CheckDelegateType<FairyGUI.GTweenCallback1>(L, pos);
	}
	...
	class FairyGUI_UIObjectFactory_GComponentCreator_Event : LuaDelegate
	{
		...
		public FairyGUI.GComponent Call()
		{
			func.BeginPCall();
			func.PCall();
			FairyGUI.GComponent ret = (FairyGUI.GComponent)func.CheckObject(TypeTraits<FairyGUI.GComponent>.type);
			func.EndPCall();
			return ret;
		}
	...
	{
		return TypeChecker.CheckDelegateType<FairyGUI.UIObjectFactory.GComponentCreator>(L, pos);
	}
	...
	class FairyGUI_UIObjectFactory_GLoaderCreator_Event : LuaDelegate
	{
		...
		public FairyGUI.GLoader Call()
		{
			func.BeginPCall();
			func.PCall();
			FairyGUI.GLoader ret = (FairyGUI.GLoader)func.CheckObject(TypeTraits<FairyGUI.GLoader>.type);
			func.EndPCall();
			return ret;
		}
	...
	{
		return TypeChecker.CheckDelegateType<FairyGUI.UIObjectFactory.GLoaderCreator>(L, pos);
	}
	...
	class UFramework_Core_UCallback_UFramework_Core_AssetRequest_Event : LuaDelegate
	{
		public UFramework_Core_UCallback_UFramework_Core_AssetRequest_Event(LuaFunction func) : base(func) { }
		public UFramework_Core_UCallback_UFramework_Core_AssetRequest_Event(LuaFunction func, LuaTable self) : base(func, self) { }

		public void Call(UFramework.Core.AssetRequest param0)
		{
			func.BeginPCall();
			func.PushObject(param0);
			func.PCall();
		...
		public void CallWithSelf(UFramework.Core.AssetRequest param0)
		{
			func.BeginPCall();
			func.Push(self);
			func.PushObject(param0);
	...
	public UFramework.Core.UCallback<UFramework.Core.AssetRequest> UFramework_Core_UCallback_UFramework_Core_AssetRequest(LuaFunction func, LuaTable self, bool flag)
	{
		if (func == null)
		{
			UFramework.Core.UCallback<UFramework.Core.AssetRequest> fn = delegate(UFramework.Core.AssetRequest param0) { };
			return fn;
		}

		if(!flag)
		{
			UFramework_Core_UCallback_UFramework_Core_AssetRequest_Event target = new UFramework_Core_UCallback_UFramework_Core_AssetRequest_Event(func);
			UFramework.Core.UCallback<UFramework.Core.AssetRequest> d = target.Call;
			target.method = d.Method;
			return d;
		}
		else
		{
			UFramework_Core_UCallback_UFramework_Core_AssetRequest_Event target = new UFramework_Core_UCallback_UFramework_Core_AssetRequest_Event(func, self);
			UFramework.Core.UCallback<UFramework.Core.AssetRequest> d = target.CallWithSelf;
			target.method = d.Method;
			return d;
		}
	}

	bool Check_UFramework_Core_UCallback_UFramework_Core_AssetRequest(IntPtr L, int pos)
	{
		return TypeChecker.CheckDelegateType<UFramework.Core.UCallback<UFramework.Core.AssetRequest>>(L, pos);
	}
