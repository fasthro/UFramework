...
public class FairyGUI_GGroupWrap
{
	...
	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	static int get_mainGridMinSize(IntPtr L)
	{
		object o = null;
		...
		try
		{
			o = ToLua.ToObject(L, 1);
			FairyGUI.GGroup obj = (FairyGUI.GGroup)o;
			int ret = obj.mainGridMinSize;
			LuaDLL.lua_pushinteger(L, ret);
			return 1;
		}
		catch(Exception e)
		{
			return LuaDLL.toluaL_exception(L, e, o, "attempt to index mainGridMinSize on a nil value");
		}
	}

	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	static int get_mainGridIndex(IntPtr L)
	{
		object o = null;
		...
		try
		{
			o = ToLua.ToObject(L, 1);
			FairyGUI.GGroup obj = (FairyGUI.GGroup)o;
			int ret = obj.mainGridIndex;
			LuaDLL.lua_pushinteger(L, ret);
			return 1;
		}
		catch(Exception e)
		{
			return LuaDLL.toluaL_exception(L, e, o, "attempt to index mainGridIndex on a nil value");
		}
	}
	...
	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	static int set_mainGridMinSize(IntPtr L)
	{
		object o = null;
	...
	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	static int set_mainGridIndex(IntPtr L)
	{
		object o = null;
