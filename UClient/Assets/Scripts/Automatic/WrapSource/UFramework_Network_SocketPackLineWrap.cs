...
public class UFramework_Network_SocketPackLineWrap
{
	public static void Register(LuaState L)
	{
		L.BeginClass(typeof(UFramework.Network.SocketPackLine), typeof(UFramework.Network.SocketPack));
		...
		L.RegFunction("New", new LuaCSFunction(_CreateUFramework_Network_SocketPackLine));
	...
	static int _CreateUFramework_Network_SocketPackLine(IntPtr L)
	{
		try
		{
			...
			if (count == 0)
			{
				UFramework.Network.SocketPackLine obj = new UFramework.Network.SocketPackLine();
			...
			else if (count == 1)
			{
				...
				UFramework.Network.SocketPackLine obj = new UFramework.Network.SocketPackLine(arg0);
				ToLua.PushObject(L, obj);
				return 1;
			}
			else
			{
				return LuaDLL.luaL_throw(L, "invalid arguments to ctor method: UFramework.Network.SocketPackLine.New");
			}
		}
		catch (Exception e)
		{
	...
	static int Pack(IntPtr L)
	{
		try
		{
			...
			UFramework.Network.SocketPackLine obj = (UFramework.Network.SocketPackLine)ToLua.CheckObject<UFramework.Network.SocketPackLine>(L, 1);
			obj.Pack();
			return 0;
		}
		catch (Exception e)
	...
	static int WriteBytes(IntPtr L)
	{
		try
		{
			...
			{
				return LuaDLL.luaL_throw(L, "invalid arguments to method: UFramework.Network.SocketPackLine.WriteBytes");
			}
		}
		catch (Exception e)
		{
	...
	static int get_packType(IntPtr L)
	{
		...
		try
		{
			...
			UFramework.Network.SocketPackLine obj = (UFramework.Network.SocketPackLine)o;
