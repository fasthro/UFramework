...
public class FairyGUI_GButtonWrap
{
	...
	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	static int get_relatedPageId(IntPtr L)
	{
		object o = null;
		...
		try
		{
			o = ToLua.ToObject(L, 1);
			FairyGUI.GButton obj = (FairyGUI.GButton)o;
			string ret = obj.relatedPageId;
			LuaDLL.lua_pushstring(L, ret);
			return 1;
		}
		catch(Exception e)
		{
			return LuaDLL.toluaL_exception(L, e, o, "attempt to index relatedPageId on a nil value");
		}
	}
	...
	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	static int set_relatedPageId(IntPtr L)
	{
		object o = null;
