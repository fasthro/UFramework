...
namespace UFramework
{
    ...
    public class AppSerdata : ISerializable
    {
        public SerializableType serializableType { get { return SerializableType.Resources; } }
        ...
        {
            Serializable<AppSerdata>.Serialization(this);
        }
    }
}