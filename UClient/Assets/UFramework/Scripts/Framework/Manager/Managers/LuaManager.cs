...
namespace UFramework
{
    public class LuaManager : BaseManager
    {
        ...
        public void LaunchEngine(ManagerContainer managerContainer)
        {
            DoFile("LuaEngine");
            ...
            luaEngine.Call("initialize", Serializer<AppConfig>.Instance, managerContainer);
        ...
        protected override void OnInitialize()
        {
            ...
            LuaCoroutine.Register(Lua, AppLauncher.Main);

            AddSearchPath();
            Lua.Start();

            _loop = AppLauncher.MainGameObject.AddComponent<LuaLooper>();
            _loop.luaState = Lua;
        }
