...
namespace UFramework.ResLoader
{
    ...
    public class AssetBundleDB
    {
        ...
        public static void Initialize()
        {
            ...
            // manifest
            manifestBundle = AssetBundle.LoadFromFile(IOPath.PathCombine(App.BundleDirectory, App.BundlePlatformName));
            manifest = manifestBundle.LoadAsset("AssetBundleManifest") as AssetBundleManifest;

            // mapping
            var ms = File.ReadAllText(IOPath.PathCombine(App.BundleDirectory, App.BundlePlatformName + ".json"));
