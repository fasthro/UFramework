...
namespace UFramework.NativePlatform
{
    ...
    public class AndroidUtils : INativeUtils
    {
        ...
        public static AndroidJavaClass Native
        {
            get
            {
                ...
                {
                    _NativeClass = new AndroidJavaClass(AndroidNative.MAIN_PACKAGE + ".core.Utils");
                }
                return _NativeClass;
            }
        }
    ...
    public class IOSUtils : INativeUtils
    {
        public void Restart()
        {
    ...
    public class UnknownUtils : INativeUtils
    {
        public void Restart()
        {
            throw new System.NotImplementedException();
    ...
    public class NativeUtils : INativeUtils
    {
