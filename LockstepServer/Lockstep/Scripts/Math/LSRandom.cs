...
namespace Lockstep
{
    ...
    public class LSRandom
    {
         ...
         **/
        public static LSRandom instance;
         ...
         **/
        public static LSRandom New(int seed)
        {
            LSRandom r = new LSRandom(seed);
            return r;
        }
        ...
        private LSRandom(int seed)
        {
            init_genrand((uint) seed);
        }

        private LSRandom(int[] init)
        {
         ...
         **/
        public static LSVector3 insideUnitSphere
        {
            get { return new LSVector3(value, value, value); }
        }
