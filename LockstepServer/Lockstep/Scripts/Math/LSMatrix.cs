namespace Lockstep
{
    ...
    public struct LSMatrix
    {
        ...
        internal static LSMatrix InternalIdentity;

        /// <summary>
        /// Identity matrix.
        /// </summary>
        public static readonly LSMatrix Identity;

        public static readonly LSMatrix Zero;

        static LSMatrix()
        {
            Zero = new LSMatrix();

            Identity = new LSMatrix();
            Identity.M11 = FP.One;
            Identity.M22 = FP.One;
            Identity.M33 = FP.One;
        ...
        public LSVector3 eulerAngles
        {
            get
            {
                ...
                result.x = LSMath.Atan2(M32, M33) * FP.Rad2Deg;
                result.y = LSMath.Atan2(-M31, LSMath.Sqrt(M32 * M32 + M33 * M33)) * FP.Rad2Deg;
                result.z = LSMath.Atan2(M21, M11) * FP.Rad2Deg;

                return result * -1;
            }
        }

        public static LSMatrix CreateFromYawPitchRoll(FP yaw, FP pitch, FP roll)
        {
            LSMatrix matrix;
            LSQuaternion quaternion;
            LSQuaternion.CreateFromYawPitchRoll(yaw, pitch, roll, out quaternion);
            CreateFromQuaternion(ref quaternion, out matrix);
            return matrix;
        }

        public static LSMatrix CreateRotationX(FP radians)
        {
            LSMatrix matrix;
        ...
        public static void CreateRotationX(FP radians, out LSMatrix result)
        {
            FP num2 = FP.Cos(radians);
            FP num = FP.Sin(radians);
            result.M11 = FP.One;
        ...
        public static LSMatrix CreateRotationY(FP radians)
        {
            LSMatrix matrix;
            FP num2 = FP.Cos(radians);
            FP num = FP.Sin(radians);
        ...
        public static void CreateRotationY(FP radians, out LSMatrix result)
        {
            FP num2 = FP.Cos(radians);
            FP num = FP.Sin(radians);
            result.M11 = num2;
        ...
        public static LSMatrix CreateRotationZ(FP radians)
        {
            LSMatrix matrix;
            FP num2 = FP.Cos(radians);
            FP num = FP.Sin(radians);
        ...
        public static void CreateRotationZ(FP radians, out LSMatrix result)
        {
            FP num2 = FP.Cos(radians);
            FP num = FP.Sin(radians);
            result.M11 = num2;
        ...
        public LSMatrix(FP m11, FP m12, FP m13, FP m21, FP m22, FP m23, FP m31, FP m32, FP m33)
        {
            this.M11 = m11;
            this.M12 = m12;
            this.M13 = m13;
        ...
        public static LSMatrix Multiply(LSMatrix matrix1, LSMatrix matrix2)
        {
            LSMatrix result;
            LSMatrix.Multiply(ref matrix1, ref matrix2, out result);
            return result;
        }
        ...
        public static void Multiply(ref LSMatrix matrix1, ref LSMatrix matrix2, out LSMatrix result)
        {
        ...
        public static LSMatrix Add(LSMatrix matrix1, LSMatrix matrix2)
        {
            LSMatrix result;
            LSMatrix.Add(ref matrix1, ref matrix2, out result);
            return result;
        }
        ...
        public static void Add(ref LSMatrix matrix1, ref LSMatrix matrix2, out LSMatrix result)
        {
        ...
        public static LSMatrix Inverse(LSMatrix matrix)
        {
            LSMatrix result;
            LSMatrix.Inverse(ref matrix, out result);
            return result;
        }
        ...
        public static void Invert(ref LSMatrix matrix, out LSMatrix result)
        {
        ...
        public static void Inverse(ref LSMatrix matrix, out LSMatrix result)
        {
        ...
        public static LSMatrix Multiply(LSMatrix matrix1, FP scaleFactor)
        {
            LSMatrix result;
            LSMatrix.Multiply(ref matrix1, scaleFactor, out result);
            return result;
        }
        ...
        public static void Multiply(ref LSMatrix matrix1, FP scaleFactor, out LSMatrix result)
        {
            FP num = scaleFactor;
        ...
        public static LSMatrix CreateFromLookAt(LSVector3 position, LSVector3 target)
        {
            LSMatrix result;
            LookAt(target - position, LSVector3.up, out result);
            return result;
        }

        public static LSMatrix LookAt(LSVector3 forward, LSVector3 upwards)
        {
            LSMatrix result;
        ...
        public static void LookAt(LSVector3 forward, LSVector3 upwards, out LSMatrix result)
        {
            LSVector3 zaxis = forward;
            zaxis.Normalize();
            LSVector3 xaxis = LSVector3.Cross(upwards, zaxis);
            xaxis.Normalize();
            LSVector3 yaxis = LSVector3.Cross(zaxis, xaxis);
        ...
        public static LSMatrix CreateFromQuaternion(LSQuaternion quaternion)
        {
            LSMatrix result;
            LSMatrix.CreateFromQuaternion(ref quaternion, out result);
            return result;
        }
        ...
        public static void CreateFromQuaternion(ref LSQuaternion quaternion, out LSMatrix result)
        {
        ...
        public static LSMatrix Transpose(LSMatrix matrix)
        {
            LSMatrix result;
            LSMatrix.Transpose(ref matrix, out result);
            return result;
        }
        ...
        public static void Transpose(ref LSMatrix matrix, out LSMatrix result)
        {
        ...
        public static LSMatrix operator *(LSMatrix value1, LSMatrix value2)
        {
            LSMatrix result;
            LSMatrix.Multiply(ref value1, ref value2, out result);
            return result;
        }
        ...
        {
            LSMatrix result;
            LSMatrix.Add(ref value1, ref value2, out result);
            return result;
        }
        ...
        {
            LSMatrix result;
            LSMatrix.Multiply(ref value2, -FP.One, out value2);
            LSMatrix.Add(ref value1, ref value2, out result);
            return result;
        }
        ...
        public static bool operator ==(LSMatrix value1, LSMatrix value2)
        {
        ...
        {
            if (!(obj is LSMatrix)) return false;
            LSMatrix other = (LSMatrix) obj;
        ...
        public static void CreateFromAxisAngle(ref LSVector3 axis, FP angle, out LSMatrix result)
        {
            FP x = axis.x;
            FP y = axis.y;
            FP z = axis.z;
        ...
        public static LSMatrix AngleAxis(FP angle, LSVector3 axis)
        {
            LSMatrix result;
