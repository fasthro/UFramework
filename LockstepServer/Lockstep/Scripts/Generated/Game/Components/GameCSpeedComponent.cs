...
public partial class GameEntity {
    ...
    public void AddCSpeed(Lockstep.FP newMoveSpeed, Lockstep.FP newRotationSpeed) {
    ...
    public void ReplaceCSpeed(Lockstep.FP newMoveSpeed, Lockstep.FP newRotationSpeed) {
        var index = GameComponentsLookup.CSpeed;
        var component = (Lockstep.CSpeed)CreateComponent(index, typeof(Lockstep.CSpeed));
        component.moveSpeed = newMoveSpeed;
        component.rotationSpeed = newRotationSpeed;
