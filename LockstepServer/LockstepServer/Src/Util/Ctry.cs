/*
 * @Author: fasthro
 * @Date: 2020-11-20 18:02:01
 * @Description: skynet crype csharp
 * https://github.com/cloudwu/skynet/blob/master/lualib-src/lua-crypt.c
 */
...
namespace LockstepServer.Src
{
    public class Crypt
    {
        ...
        private static void des_main_ks(UInt32[] SK, byte[] key)
        {
            int i;
        ...
        private static void des_crypt(UInt32[] SK, Byte[] input, int inputIndex, Byte[] output, int outputIndex)
        {
            UInt32 X, Y, T = 0;
